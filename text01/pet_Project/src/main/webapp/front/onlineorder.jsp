    ...
    <section class="Content">
        <div class="onlineorder">
            ...
            <div class="orderbox">
                ...
                <div class="itemlist">
                    <dl>
                        <dt class="dt1"><input type="radio" id="radio" onclick="onclick" name="mg" class="radio"><span class="radio2">73mg</span><input type="radio" name="mg" class="radio"  id="radio2"><span class="radio2" onclick="radio2()">300mg</span> </dt>
